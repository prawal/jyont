...
public class Engine extends NgnEngine{
	...
	private static final String CONTENT_TITLE = "Joynt";
	...
	private void showNotification(int notifId, int drawableId, String tickerText) {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(Joynt.getContext(), notifId/*requestCode*/, intent, PendingIntent.FLAG_UPDATE_CURRENT);     

        // Set the info for the views that show in the notification panel.
        notification.setLatestEventInfo(Joynt.getContext(), CONTENT_TITLE, tickerText, contentIntent);
