...
*	
* This file is part of Joynt Project (http://code.google.com/p/Joynt)
*
* Joynt is free software: you can redistribute it and/or modify it under the terms of 
* the GNU General Public License as published by the Free Software Foundation, either version 3 
* of the License, or (at your option) any later version.
*	
* Joynt is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY;
...
public class NativeService extends NgnNativeService {
	...
	public NativeService(){
		...
		Log.d(TAG, "Native Service Constructor");
	}
	...
	public void onStart(Intent intent, int startId) {
		...
		mBroadcastReceiver = new BroadcastReceiver() {
			...
			public void onReceive(Context context, Intent intent) {
				...
				Log.d(TAG, NgnInviteEventArgs.ACTION_INVITE_EVENT.toString());
				Log.d(TAG, action.toString());
				// Invite Events
				if(NgnInviteEventArgs.ACTION_INVITE_EVENT.equals(action)){
					Log.d(TAG, "Incomming Call");
